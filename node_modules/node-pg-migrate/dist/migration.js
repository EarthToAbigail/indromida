  ...
  _createClass(Migration, [{
    ...
    value: function _apply(action, pgm) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        if (!_this.options.single_transaction && pgm.isUsingTransaction()) {
          // if not in single_transaction mode we need to create our own transaction
          sqlSteps.unshift('BEGIN;');
          sqlSteps.push('COMMIT;');
        } else if (_this.options.single_transaction && !pgm.isUsingTransaction()) {
    ...
    value: function applyUp() {
      var pgm = new _migrationBuilder2.default(this.options, this.db);
